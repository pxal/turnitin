...
export default function AdminLayout({ children }: { children: ReactNode }) {
  ...
  return (
    <div style={{ minHeight: "100vh", background: "#f1f5f9", color: "#0f172a", fontFamily: "'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif" }}>
      ...
      <div style={{ display: "flex", minHeight: "100vh" }}>
        <aside
          style={{
            width: isMobile ? "min(86vw, 280px)" : "260px",
            background: "#ffffff",
        ...
        >
          ...
          >
            ...
            <div style={{ minWidth: 0 }}>
              ...
              <div style={{ fontSize: "12px", color: "#94a3b8", fontWeight: 500 }}>Admin Panel</div>
            </div>
          </div>

          <nav style={{ padding: "16px 12px", display: "grid", gap: "2px", flex: 1 }}>
            <div style={{ padding: "0 12px", marginBottom: "8px" }}>
              <span style={{ fontSize: "11px", fontWeight: 700, color: "#94a3b8", textTransform: "uppercase", letterSpacing: "0.08em" }}>Menu</span>
            </div>
            {menuItems.map((item) => {
              ...
              return (
                ...
                >
                  {item.icon(active)}
                  <span style={{ fontWeight: active ? 600 : 500, fontSize: "14px", flex: 1 }}>{item.label}</span>
                  {item.badge ? (
                    <span
                      style={{
                        minWidth: "22px",
          ...
          >
            ...
            >
              ...
              <div style={{ minWidth: 0, flex: 1 }}>
                <div style={{ fontWeight: 600, fontSize: "13px", color: "#0f172a" }}>Admin Root</div>
        ...
        <div style={{ flex: 1, minWidth: 0, display: "flex", flexDirection: "column" }}>
          ...
          >
            <div style={{ display: "flex", alignItems: "center", gap: "12px", minWidth: 0 }}>
              ...
              <div style={{ minWidth: 0 }}>
                <div style={{ fontSize: isMobile ? "18px" : "17px", fontWeight: 700, color: "#0f172a" }}>
                  {activeItem?.label || "Admin"}
                </div>
                {!isMobile ? (
                  <div style={{ fontSize: "13px", color: "#94a3b8", fontWeight: 500 }}>Selamat datang kembali, Admin</div>
                ) : null}
              </div>
            </div>
          ...
          <main style={{ padding: isMobile ? "16px" : "24px 28px 36px", flex: 1 }}>{children}</main>
        </div>
      </div>
